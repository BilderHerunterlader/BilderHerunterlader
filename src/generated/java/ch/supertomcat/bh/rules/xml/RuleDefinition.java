...
public class RuleDefinition {
     ...
     * This is why there is not a <CODE>set</CODE> method for the pipes property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the pipes property.
     */
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the failuresPipes property.</p>
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * </p>
     ...
     * 
     * @return
     *     The value of the failuresPipes property.
     */
    public List<FailuresPipeline> getFailuresPipes() {
        if (failuresPipes == null) {
            failuresPipes = new ArrayList<>();
        }
