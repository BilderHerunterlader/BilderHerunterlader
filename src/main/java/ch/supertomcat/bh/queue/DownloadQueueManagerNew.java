 ...
 */
public class DownloadQueueManagerNew extends QueueManagerBase<PicDownloadListener, PicDownloadResult> {
	/**
	 * Listener
	 */
	 ...
	 */
	public DownloadQueueManagerNew(DownloadQueueManagerRestrictions restrictions, SettingsManager settingsManager, QueueTaskFactory<PicDownloadListener, PicDownloadResult> queueTaskFactory) {
