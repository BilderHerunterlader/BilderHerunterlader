<pre>
BilderHerunterlader can also be used from an USB-Stick. But an installed JRE on the computers or a portable Java Runtime like jPortable is still required.
...
The directories.properties file must look like this:
</pre>
<div class="code">
<pre>
DatabasePath=data/
...
<pre>
In the example above the databases, settings and logs would be saved in the programmfolder in the subfolder "data". And downloaded files in subfolder "downloads".
...
But it would also be possible to define the directories by absolute paths.
</pre>
